//This function will dictate how the Support Enthusiast commander responds to threats!
...
if (_Lvl <= 2) exitWith
{
	...
	_wp2 setWaypointSpeed "NORMAL";
		...
		[_Grp,_Color,_mkr,_CSide],
		{
			...
			if (isServer) then {[_Cside,_Marker,_Group,"SupportEnthusiast"] call DIS_fnc_mrkersave; };
