...
private _grp = createGroup _CSide;
{
	...
	_unit = _grp createUnit [((_rndU select 0) select 0) ,[0,0,0], [], 0, "FORM"];
...

{
	...
	private _para = createVehicle ["NonSteerable_Parachute_F",[_SpwnPos select 0,_SpwnPos select 1,(_SpwnPos select 2) + 400], [], 0, ""];
