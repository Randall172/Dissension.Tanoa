...
//Send the message!
["DEFENCE COMMANDER: EASY TERRITORY TARGETTED",'#FFFFFF'] remoteExec ["MessageFramework",_CSide];
_AddNewsArray = ["Easy Target",format 
[
"
	The location at, %1 is an easy target to defend from our enemy. Let's take it before they are able to use it against us!<br/>
"
...
if (_WestRun) then 
{
	...
	[_grp,West],
	{
			...
			if (isServer) then {[_Cside,_Marker,_Group,"CloseCapture"] call DIS_fnc_mrkersave; };
