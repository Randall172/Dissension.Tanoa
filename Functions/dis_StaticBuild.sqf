...
_StaticArray = E_StaticWeap;
if (_WestRun) then
{
	private _Mrkrcolor = "ColorBlue";
	private _RSide = West;
	private _MrkrType = "b_installation";
...
_RoadStatic setDir ([_RoadStatic,_CE] call BIS_fnc_dirTo);
...
[_RandomStatic,_Mrkrcolor,_MrkrType,_RSide],
{
	...
	_Marker = createMarkerLocal [format ["ID_%1",_RandomStatic],[0,0,0]];
