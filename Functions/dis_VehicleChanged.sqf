...
if ((DIS_PCASH - _CashAmount) < 0) then {((findDisplay (3016)) displayCtrl 1001) ctrlSetTextColor [0.99,0.13,0.09,1];} else {((findDisplay (3016)) displayCtrl 1001) ctrlSetTextColor [0,0.76,0,1];};
