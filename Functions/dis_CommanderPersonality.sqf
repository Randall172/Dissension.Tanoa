...
if ((side _this) isEqualTo West) then
{
	...
	_MoodTraitArray = [
										...
										["Guerrilla","This commander likes to play as dirty as possible while remaining out of the thick of things. This means laying traps, setting up frequent ambushes, stealing enemy tech, and even creating fake caches laced with explosives."]
										];
